package com.example.realreal.Alarm.alarmslist;
...
public class AlarmViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(Alarm alarm) {
        ...
        if (alarm.getTitle().length() != 0) {
            alarmTitle.setText(String.format("%s", alarm.getTitle(), alarm.getAlarmId(), alarm.getCreated()));
        } else {
            alarmTitle.setText(String.format("%s", "Alarm", alarm.getAlarmId(), alarm.getCreated()));
        }
